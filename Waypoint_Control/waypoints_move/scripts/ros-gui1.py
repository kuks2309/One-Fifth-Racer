...
def read_gps_waypoints_data(self):
	...
	if lines_num >1 :
		gps_waypoints_data = np.zeros((lines_num, 2))
	
	
	for line in lines:
		lon, lat = line.split()
		gps_waypoints_data[i][0] = float(lon)
		gps_waypoints_data[i][1] = float(lat)
...
class Ui_Dialog(object):
	...
	rospy.Subscriber('/gps/fix_front',  NavSatFix, self.subGPS1FixDataCallback)
    ...
    def setupUi(self, Dialog):
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(565, 180, 141, 81))
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(710, 180, 57, 81))
        ...
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(560, 40, 211, 91))
